...
if __name__ == "__main__":
    ...
    cosine_pooling = torch.nn.functional.cosine_similarity(pool_vectors[0], pool_vectors[1], dim=0)       # Fill up this '----------' section
    cosine_cls = torch.nn.functional.cosine_similarity(cls_vectors[0], cls_vectors[1], dim=0)       # Fill up this '----------' section
